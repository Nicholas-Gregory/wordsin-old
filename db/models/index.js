...
const AdvanceWorld = require('./AdvanceWorld');
...
AffectToAdvance.belongsToMany(LinkInWorld, {
    through: AdvanceWorld,
    foreignKey: 'advanceId'
});
LinkInWorld.belongsToMany(AffectToAdvance, {
    through: AdvanceWorld,
    foreignKey: 'worldLinkId'
});
